...
--
-- Table structure for table `leave_balance_report`
--

DROP TABLE IF EXISTS `leave_balance_report`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `leave_balance_report` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `version` bigint(20) NOT NULL,
  `employee_id` bigint(20) NOT NULL,
  `floating_leave` double NOT NULL,
  `paid_leave` double DEFAULT NULL,
  `personal_leave` double NOT NULL,
  `sick_leave` double NOT NULL,
  `unpaid_leave` double DEFAULT NULL,
  `year` varchar(255) NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `unique_employee_id` (`year`,`employee_id`),
  KEY `FK_6qvhm4xnqeqq95e2ytnpt3206` (`employee_id`),
  CONSTRAINT `FK_6qvhm4xnqeqq95e2ytnpt3206` FOREIGN KEY (`employee_id`) REFERENCES `employee` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `leave_balance_report`
--

LOCK TABLES `leave_balance_report` WRITE;
/*!40000 ALTER TABLE `leave_balance_report` DISABLE KEYS */;
/*!40000 ALTER TABLE `leave_balance_report` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `leave_type` VALUES (1,0,0,'Day Off','Paid','Active'),(2,0,0,'Night Off','Paid','Active'),(3,0,0,'Substitute Leave','Paid','Active'),(4,0,0,'Festival Off','Paid','Active');
...
-- Dump completed on 2015-01-09 16:12:50
