            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="supervisor.employee.label" default="Employee" /></td>
                            
                            <td valign="top" class="value"><g:link controller="employee" action="show" id="${supervisorInstance?.employee?.id}">${supervisorInstance?.employee?.encodeAsHTML()}</g:link></td>
