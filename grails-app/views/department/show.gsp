	...
	<body>
		...
		<div id="show-department" class="content scaffold-show" role="main">
			...
			<ol class="property-list department">
				...
				<g:if test="${departmentInstance?.level}">
				<li class="fieldcontain">
					<span id="level-label" class="property-label"><g:message code="department.level.label" default="Level" /></span>
					
						<span class="property-value" aria-labelledby="level-label"><g:fieldValue bean="${departmentInstance}" field="level"/></span>
